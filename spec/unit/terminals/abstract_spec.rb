...
RSpec.describe TTY::Link::Terminals::Abstract do
  ...
  describe "#term" do
    ...
    it "accesses the missing term environment variable in a subclass" do
      stub_const("Terminal", Class.new(described_class) do
        def name
          term
        end
      ...
      expect(terminal.name).to eq(nil)
    end
  end
  ...
  describe "#term_program" do
    ...
    it "accesses the missing term program environment variable in a subclass" do
      stub_const("Terminal", Class.new(described_class) do
        def name
          term_program
        end
